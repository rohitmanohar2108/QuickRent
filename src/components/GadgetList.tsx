...
export default function GadgetList() {
  ...
  return (
    <div id="gadgets" className="bg-white dark:bg-gray-900 py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="flex-1 p-6 flex flex-col justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-3 text-2xl text-indigo-600 dark:text-indigo-400">{gadget.price}</p>
        ...
        <div className="mt-16 text-center">
          <motion.button
            ...
            className="inline-flex items-center px-6 py-3 border border-indigo-600 text-indigo-600 dark:text-indigo-400 dark:border-indigo-400 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-900/50 transition-colors"
          >
